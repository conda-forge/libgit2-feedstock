...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libgit2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libgit2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `libgit2` available on your platform:
...
```
pixi search libgit2 --channel conda-forge
```
